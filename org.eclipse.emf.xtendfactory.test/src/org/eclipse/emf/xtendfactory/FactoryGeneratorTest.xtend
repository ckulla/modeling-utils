...
class FactoryGeneratorTest {
	...
	def loadGenModel () {
		val genModel = "platform:/resource/org.eclipse.emf.xtendfactory.test/src/org/eclipse/emf/xtendfactory/XtendFactoryTest.genmodel"	
	...
	def void testCompareContents () {		
		...
		assertEquals ('''
			package org.eclipse.emf.xtendfactory.test.foo.util
			
			import org.eclipse.emf.xtendfactory.test.foo.Baz
			import org.eclipse.emf.xtendfactory.test.foo.FooFactory
			
			class FooFactoryXtend {
				
				def createBaz( (Baz) => void initializer) {
