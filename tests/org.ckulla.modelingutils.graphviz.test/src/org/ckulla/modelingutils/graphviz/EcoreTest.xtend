		...
		assertEquals (
			...
			digraph "ecore" {
				...
				subgraph "cluster_ecore" {
					...
					2 [shape=record,label="{EClass|}",fillcolor=grey,fontcolor=black,style=filled, bold];
					3 [shape=record,label="{\<\<abstract\>\>\nEClassifier|}",fillcolor=white,fontcolor=black,style=filled, bold];
					4 [shape=record,label="{EDataType|}",fillcolor=grey,fontcolor=black,style=filled, bold];
					5 [shape=record,label="{EEnum|}",fillcolor=grey,fontcolor=black,style=filled, bold];
					6 [shape=record,label="{EEnumLiteral|}",fillcolor=grey,fontcolor=black,style=filled, bold];
					7 [shape=record,label="{EFactory|}",fillcolor=grey,fontcolor=black,style=filled, bold];
					8 [shape=record,label="{\<\<abstract\>\>\nEModelElement|}",fillcolor=white,fontcolor=black,style=filled, bold];
					9 [shape=record,label="{\<\<abstract\>\>\nENamedElement|}",fillcolor=white,fontcolor=black,style=filled, bold];
					10 [shape=record,label="{EObject|}",fillcolor=grey,fontcolor=black,style=filled, bold];
					11 [shape=record,label="{EOperation|}",fillcolor=grey,fontcolor=black,style=filled, bold];
					12 [shape=record,label="{EPackage|}",fillcolor=grey,fontcolor=black,style=filled, bold];
					...
					15 [shape=record,label="{\<\<abstract\>\>\nEStructuralFeature|}",fillcolor=white,fontcolor=black,style=filled, bold];
